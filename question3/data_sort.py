...
# 读取聚类结果数据
data1 = pd.read_excel("../data/data1_DBSCAN_and_Kmeans.xlsx")
...
# 按照新的顺序重排，并将task_id列从 index 中剔除，变为普通列
distance1_sorted = distance1.loc[sorted_task_ids].reset_index()

data1.to_excel("../data/data1_sorted.xlsx", index=False)
distance1_sorted.to_excel("../data/task_to_member_distance_sorted.xlsx", index=False)
